...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        drawWheel(-gap / 2.0f, 0.0f, wheelRadius, 25, VAO, VBO, shaderProgram);
...
void drawWheel(float x, float y, float radius, int numSegments, unsigned int &VAO, unsigned int &VBO, unsigned int shaderProgram)
{
    ...
    drawFilledAnnulus(x, y, radius + tireThickness, radius, numSegments, glm::vec3(0.0f, 0.0f, 1.0f), VAO, VBO, shaderProgram);

    // Draw the spokes and inner circle with white color
    drawCircle(x, y, radius, numSegments, glm::vec3(0.0f, 0.0f, 1.0f), VAO, VBO, shaderProgram);
...
void drawFrame(float x1, float y1, float x2, float y2, unsigned int &VAO, unsigned int &VBO, unsigned int shaderProgram)
{
    ...
    // Set the line width
    glLineWidth(5.0f); // Change this value to the desired line width
